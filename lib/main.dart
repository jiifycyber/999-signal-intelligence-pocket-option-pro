...
class _NexusDashboardState extends State<NexusDashboard> {
  ...
  List<String> get _liveScanPairs {
    final pairs = latestPrices.keys.toList();
    pairs.sort();
    return pairs;
  }
  ...
  Widget _buildMobileDashboard(BuildContext context) {
    ...
    final scanPairs = latestPrices.keys.toList()..sort();
...
// MIN PROBABILITY
                      ...
                      // SCANNER ROWS
                      for (int i = 0; i < _liveScanPairs.length; i++)
                        hit(
                          left: 297,
                          top: 294 + (i * 47),
                          width: 998,
                          height: 44,
                          onTap: () {
                            final pair = _liveScanPairs[i];

                            setState(() => selectedPair = pair);
                            showSignalDetails(pair);
                          },
                        ),

    ...
    return PlatformShell(
      ...
      children: [
        ...
        PlatformToolTile(
          ...
          description:
              'Professional live chart and scanner intelligence workspace.',
        ...
        PlatformToolTile(
          ...
          onTap: onOpenMultiChart,
        ),
        PlatformToolTile(
          title: 'Drawing Tools',
          description: 'Trendlines, levels, Fibonacci and annotations.',
          icon: Icons.draw,
          onTap: onOpenDrawingTools,
        ),
        PlatformToolTile(
          title: 'Indicators',
          description: 'Technical indicators and overlays.',
          icon: Icons.query_stats,
          onTap: onOpenIndicatorCenter,
        ),
        PlatformToolTile(
          title: 'Chart Alerts',
          description: 'Price, signal, momentum and indicator alerts.',
          icon: Icons.notifications_active_outlined,
          onTap: onOpenChartAlerts,
        ),
        PlatformToolTile(
          title: 'Layouts',
          description: 'Professional saved chart workspace presets.',
          icon: Icons.dashboard_customize,
          onTap: onOpenChartLayouts,
        ),
